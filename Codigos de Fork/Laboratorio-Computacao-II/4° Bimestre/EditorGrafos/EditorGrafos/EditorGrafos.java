...
public class EditorGrafos extends JFrame
{
    ...
    public EditorGrafos() {
        ...
        actRenomearVertice = new RenomearAction(iconRenomearVertice);
        actRemoverVertice = new RemoverAction(iconRemoverVertice);
    ...
    private Action actNovoGrafo, actCarregarGrafo, actGravarGrafo,actRemoverVertice;
    private Action actAdicionarVertice, actMoverVertice, actNovaAresta,actRenomearVertice;
    ...
    private class RenomearAction extends AbstractAction {
        public RenomearAction(String nome, Icon icon) {
            super(nome, icon);
            putValue(SHORT_DESCRIPTION, "Aciona modo para renomear um vértice ou aresta.");
            putValue(MNEMONIC_KEY, KeyEvent.VK_M);
        }
        public RenomearAction(Icon icon) { this(null, icon); }
    ...
    private class RemoverAction extends AbstractAction {
       public RemoverAction(String nome, Icon icon) {
           super(nome, icon);
           putValue(SHORT_DESCRIPTION, "Aciona modo para remover um vértice.");
           putValue(MNEMONIC_KEY, KeyEvent.VK_M);
       }
       public RemoverAction(Icon icon) { this(null, icon); }
        
       @Override
       public void actionPerformed(ActionEvent e) {
           desenhista.setModoEdicao(DesenhistaGrafo.ModoEdicao.REMOVER_VERTICE);
       }
    }
