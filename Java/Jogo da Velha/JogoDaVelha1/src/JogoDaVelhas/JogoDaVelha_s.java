 ...
 * @author Thiago Romão
 */
public class JogoDaVelha_s extends javax.swing.JFrame {

    /**
     * Creates new form JogoDaVelha_s
     */
    public JogoDaVelha_s() 
    {
        initComponents();
        setSize(1200,600);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JogoDaVelha_s.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JogoDaVelha_s().setVisible(true);
            }
        });
    }
